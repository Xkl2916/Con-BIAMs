...
from src.modules.position_embedding import SinusoidalPositionalEmbedding
from src.modules.multihead_attention import MultiheadAttention
from src.modules.encoders import DIVEncoder
import math
...
class GatedTransformer(nn.Module):
    ...
    Args:
        ...
        res_dropout (float): dropout applied on the residual block      # 残差网络的丢弃率
        attn_mask (bool): whether to apply mask on the attention weights    # 遮挡的mask
    """
